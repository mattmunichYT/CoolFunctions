...
execute as @e[type=minecraft:arrow,limit=1,sort=nearest,nbt={weapon:{id:"minecraft:bow",components:{"minecraft:custom_data":{ender_bow:true}}}}] positioned as @s run particle minecraft:witch ~ ~ ~ 0 0 0 1 10

execute at @e[type=minecraft:arrow,nbt={weapon:{id:"minecraft:bow",count:1,components:{"minecraft:damage":1,"minecraft:custom_data":{ender_bow:true}}}}] positioned as @s if block ~ ~ ~ minecraft:water run ride @p dismount
execute as @e[type=minecraft:arrow,nbt={weapon:{id:"minecraft:bow",count:1,components:{"minecraft:damage":1,"minecraft:custom_data":{ender_bow:true}}}}] positioned as @s if block ~ ~ ~ minecraft:water run playsound minecraft:entity.ender_eye.death player @a[distance=..20] ~ ~ ~ 10 1 1
execute as @e[type=minecraft:arrow,nbt={weapon:{id:"minecraft:bow",count:1,components:{"minecraft:damage":1,"minecraft:custom_data":{ender_bow:true}}}}] positioned as @s if block ~ ~ ~ minecraft:water run kill @s
execute as @e[type=minecraft:arrow,nbt={weapon:{id:"minecraft:bow",count:1,components:{"minecraft:damage":1,"minecraft:custom_data":{ender_bow:true}}}}] positioned as @s unless block ~ ~-1 ~ #minecraft:air run playsound minecraft:entity.ender_eye.death player @a[distance=..20] ~ ~ ~ 10 1 1
execute as @e[type=minecraft:arrow,nbt={weapon:{id:"minecraft:bow",count:1,components:{"minecraft:damage":1,"minecraft:custom_data":{ender_bow:true}}}}] positioned as @s unless block ~ ~-1 ~ #minecraft:air run kill @s